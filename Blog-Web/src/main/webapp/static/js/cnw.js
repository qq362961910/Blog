    ...
    window._ssp_global = window._ssp_global || {}, function (t) {
        ...
        t.setPath("https://dup.baidustatic.com/"), t.define({
            ...
            processExtendsParam: function (t) {
                var e = t.response, i = e.placement.container, n = e.pdb_deliv, o = e.rtb_deliv, r = e.order_deliv;
            ...
            getPmpRequestUrl: function (t) {
                ...
                if (c) {
                    ...
                    var h = t.width, u = t.height;
                    h > 0 && u > 0 && (i.sz && (i.sz = ""), n.push("sz=" + h + "x" + u)), t.pcwd && n.push("conwid=" + h), t.pchd && n.push("conhei=" + u);
                    var p = c.pdb_deliv;
                    p.deliv_id && n.push("pdbid=" + p.deliv_id), c.media_protect && n.push("mpdi=" + c.media_protect);
                    var m = c.order_deliv;
                    m.deliv_id && n.push("orderid=" + m.deliv_id), m.demand_id && n.push("odid=" + m.demand_id);
                    var f = c.rtb_deliv;
                    f.deliv_id && n.push("rtbid=" + f.deliv_id), f.demand_id && n.push("rdid=" + f.demand_id);
                    var g = c.placement.complement_type;
                    if (t.isNeedCacheRequest || 4 === g || 7 === g) {
                        var y = i.qn;
                        i.dpv = y, t.paramObj.dpv = y, this.requestCache.add(y, t)
                    }
                ...
                var v = n.join("&");
                return e = t.posUrl && (this.browser.uc || this.browser.tencent) ? t.posUrl + v + "&" + this.getParamString(i) : this.config.POS_URL + v + "&" + this.getParamString(i)
            }
        }), t.define({
            name: "slot",
            namespace: "dup.business",
            ...
            createSlot: function (t) {
                ...
                var n = {};
                return n.index = this.slotIdCountMap[i]++, n.count = ++this.slotCount, n.id = i + "_" + n.index, n.containerId = this.config.DUP_PREFIX + "_wrapper_" + i + "_" + n.index, n.slotId = t.slotId, n.productLine = t.productLine, n.errors = [], n.isAsync = t.isAsync, this.setStatus(n.id, this.config.STATUS_CREATE), e ? n.timestampWatcher = {t1: e} : n.timestampWatcher = {
                    t1: 0
                ...
                for (var t, e = 0, i = this.delieveryObjArray.length; i > e; e++) {
                    ...
                    if (n.hasOwnProperty("id")) {
                        ...
                        if (n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync : n.hasOwnProperty("async") && n.async && (o = n.async), t = this.slot.createSlot({
                                ...
                                productLine: "adcodex",
                                isAsync: o
                            }), n.hasOwnProperty("pos")) {
                            try {
                                this.QueryURI = this.url.getQueryURI(2)
                            } catch (r) {
                                this.QueryURI = ["a", "o"]
                            }
                            t.posUrl = this.config.HTTP_PROTOCOL + "//" + n.pos + "/s?", t.pcn = n.pos
                        }
                        if (this.additionalParam.paramCheck(t, n), t.containerId = n.container || t.containerId, t.display = n.display, t.rpdn = n.rpdn || "", t.ftpc = n.ftpc || !1, t.size = n.size || "", t.pcwd = n.pcwd || "", t.pchd = n.pchd || "", !t.styleOpenApi.cpro_w && !t.styleOpenApi.cpro_h) {
                            var s, a = n.size;
                            if (a && a.indexOf(":") > -1) {
                                s = a.split(":");
                                var d = this.param.translateScaleToPixelSize(s[0], s[1]);
